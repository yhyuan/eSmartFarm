var cmOnSuccessCallback, collectionObj, helpers, registeredAutoFormHooks;
...
Template.autoformModals.rendered = function() {
  ...
  return $('#afModal').on('hidden.bs.modal', function() {
    ...
    sessionKeys = ['cmCollection', 'cmOperation', 'cmDoc', 'cmButtonHtml', 'cmFields', 'cmOmitFields', 'cmButtonContent', 'cmTitle', 'cmButtonClasses', 'cmPrompt', 'cmTemplate', 'cmLabelClass', 'cmInputColClass', 'cmPlaceholder'];
    results = [];
